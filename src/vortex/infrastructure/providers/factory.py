...
from .builders import BarchartProviderBuilder, IBKRProviderBuilder, YahooProviderBuilder
...
class ProviderFactory:
    ...
    def create_provider(
        self, provider_name: str, config_override: Optional[Dict[str, Any]] = None
    ...
    def create_provider_with_builder(
        self, provider_name: str, builder_config_func=None
    ):
    ...
    def _build_barchart_provider(
        ...
        try:
            ...
            if "missing" in str(e) and "positional arguments" in str(e):
                raise ValueError(
                    "Missing required configuration for Barchart provider: username, password"
                )
            raise
