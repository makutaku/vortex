...
DEPRECATED: This module is deprecated. Import from vortex.providers.barchart instead:
...
warnings.warn(
    ...
    "Use 'from vortex.providers.barchart import BarchartDataProvider' instead.",
    DeprecationWarning,
    stacklevel=2
)
