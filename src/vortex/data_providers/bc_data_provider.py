...
DEPRECATED: This module is deprecated. Import from vortex.data_providers.barchart instead:
    from vortex.data_providers.barchart import BarchartDataProvider
"""
...
warnings.warn(
    ...
    "Use 'from vortex.data_providers.barchart import BarchartDataProvider' instead.",
    DeprecationWarning,
    stacklevel=2
)
