...
class DependencyRegistry:
    ...
    def register_optional_module(
        self, name: str, import_func: Callable, fallback: Any = None
    ):
...
class NullUX:
    ...
    def set_force_yes(self, force: bool):
        pass
...
def _import_resilience():
    ...
    from vortex.infrastructure.resilience.correlation import (
...
def _import_commands():
    ...
    from .commands import config, download, metrics, providers, validate
...
def _import_ux():
    ...
    return {"get_ux": get_ux, "CommandWizard": CommandWizard}
...
def initialize_dependencies():
    ...
    _registry.register_optional_module("rich", _import_rich, fallback={"Console": None})
    ...
    _registry.register_optional_module(
        "ux",
        _import_ux,
        fallback={"get_ux": lambda: NullUX(), "CommandWizard": NullWizard},
    )

    # Register resilience commands
    _registry.register_optional_module(
        "resilience_commands", _import_resilience_commands, fallback=None
    )
