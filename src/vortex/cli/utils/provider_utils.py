...
from vortex.infrastructure.plugins import PluginNotFoundError, get_provider_registry
...
def get_provider_config_from_vortex_config(
    provider: str, vortex_config
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        return {"timeout": 30, "max_retries": 3, "enabled": True}
