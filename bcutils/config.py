...
CONTRACT_MAP = {
    ...
    # "GOOG": {"code": "GOOG", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "2014-03-27"},
    # "GOOGL": {"code": "GOOGL", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "2014-03-27"},
    "AMZN": {"code": "AMZN", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "1997-05-15"},
    "MSFT": {"code": "MSFT", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "1986-03-13"},
    # "IBM": {"code": "IBM", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "1915-06-29"},
    "AAPL": {"code": "AAPL", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "1980-12-12"},
    # "INTC": {"code": "INTC", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "1971-03-17"},
    "NFLX": {"code": "NFLX", "tick_date": "2008-05-05", "type": "stock", "backfill_date": "2002-05-23"},
    # "AMGN": {"code": "AMGN", "tick_date": "1991-04-04", "type": "stock", "backfill_date": "1983-09-30"},
    "NVDA": {"code": "NVDA", "tick_date": "1999-01-22", "type": "stock", "backfill_date": "1999-01-22"},
    # "PYPL": {"code": "PYPL", "tick_date": "2015-07-20", "type": "stock", "backfill_date": "2015-07-06"},
    #"TSLA": {"code": "TSLA", "tick_date": "2010-06-29", "type": "stock", "backfill_date": "2010-06-29"},
    # "INTU": {"code": "INTU", "tick_date": "1993-03-10", "type": "stock", "backfill_date": "1993-03-10"},
    # "AMD": {"code": "AMD", "tick_date": "1980-03-17", "type": "stock", "backfill_date": "1980-03-17"},
    # "GS": {"code": "GS", "tick_date": "1999-05-04", "type": "stock", "backfill_date": "1999-05-04"},
    # "DIS": {"code": "DIS", "tick_date": "1970-12-31", "type": "stock", "backfill_date": "1957-01-01"},
    # "BA": {"code": "BA", "tick_date": "1980-03-17", "type": "stock", "backfill_date": "1962-01-02"},
    # "MS": {"code": "MS", "tick_date": "1990-05-31", "type": "stock", "backfill_date": "1990-05-31"},
    # "JPM": {"code": "JPM", "tick_date": "1981-09-30", "type": "stock", "backfill_date": "1981-09-30"},
    # "WMT": {"code": "WMT", "tick_date": "1970-01-02", "type": "stock", "backfill_date": "1970-01-02"},
    # "V": {"code": "V", "tick_date": "2008-03-19", "type": "stock", "backfill_date": "2008-03-19"},
    # "HD": {"code": "HD", "tick_date": "1981-09-22", "type": "stock", "backfill_date": "1981-09-22"},
    # "T": {"code": "T", "tick_date": "1983-12-30", "type": "stock", "backfill_date": "1983-12-30"},
    # "VZ": {"code": "VZ", "tick_date": "1983-11-17", "type": "stock", "backfill_date": "1983-11-17"},
    # "CVX": {"code": "CVX", "tick_date": "1984-07-02", "type": "stock", "backfill_date": "1984-07-02"},
    # "XOM": {"code": "XOM", "tick_date": "1970-03-31", "type": "stock", "backfill_date": "1970-03-31"},
    # "MRK": {"code": "MRK", "tick_date": "1970-06-30", "type": "stock", "backfill_date": "1970-06-30"},
    # "PFE": {"code": "PFE", "tick_date": "1970-01-02", "type": "stock", "backfill_date": "1970-01-02"},
    # "KO": {"code": "KO", "tick_date": "1962-01-02", "type": "stock", "backfill_date": "1962-01-02"},
    # "PEP": {"code": "PEP", "tick_date": "1970-01-02", "type": "stock", "backfill_date": "1970-01-02"},
    # "JNJ": {"code": "JNJ", "tick_date": "1970-01-02", "type": "stock", "backfill_date": "1970-01-02"},
    # "CSCO": {"code": "CSCO", "tick_date": "1990-02-16", "type": "stock", "backfill_date": "1990-02-16"},
    # "WBA": {"code": "WBA", "tick_date": "1970-01-02", "type": "stock", "backfill_date": "1970-01-02"},
    # "PG": {"code": "PG", "tick_date": "1970-01-02", "type": "stock", "backfill_date": "1970-01-02"}
