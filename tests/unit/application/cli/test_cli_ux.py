...
from vortex.application.cli.ux import (
    CliUX, ProgressContext, TableBuilder, TreeBuilder, 
    CommandWizard, enhanced_error_handler, validate_symbols
)
from vortex.application.cli.help import HelpSystem
from vortex.application.cli.completion import (
    complete_provider, complete_symbol, complete_date,
    CompletionInstaller
)
from vortex.application.cli.analytics import CliAnalytics, analytics_decorator
...
class TestCommandWizard:
    ...
    def test_config_wizard(self, mock_confirm, mock_prompt, mock_choice, wizard):
        ...
        mock_confirm.side_effect = [True]  # configure general settings
...
class TestErrorHandler:
    ...
    def test_enhanced_error_handler_vortex_error(self):
        ...
        with pytest.raises(SystemExit):  # click.Abort raises SystemExit in tests
            failing_function()
...
class TestCLIIntegration:
    ...
    def test_wizard_to_command_config_conversion(self):
        ...
        from vortex.application.cli.main import _convert_wizard_config_to_params
